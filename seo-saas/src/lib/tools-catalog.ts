...
export const TOOLS: ToolDef[] = [
  ...
  { slug: 'robots-meta-generator', title: 'Meta Robots Noindex Generator', short: 'noindex, nofollow, canonical & X-Robots-Tag for a single page.', category: 'generate', icon: EyeOff, keywords: 'meta robots noindex generator nofollow x-robots-tag canonical index tag' },
  ...
  { slug: 'netlify-redirects-generator', title: 'Netlify Redirects Generator', short: 'Turn old → new URLs into a Netlify _redirects file (301/302).', category: 'generate', icon: CornerUpRight, keywords: 'netlify redirects generator _redirects file 301 302 rules' },
  { slug: 'vercel-redirects-generator', title: 'Vercel Redirects Generator', short: 'Build a valid vercel.json redirects array (301/308) in seconds.', category: 'generate', icon: CornerUpRight, keywords: 'vercel redirects generator vercel.json 301 308 permanent rules' },
  { slug: 'cloudflare-redirect-rules-generator', title: 'Cloudflare Redirect Rules Generator', short: 'Cloudflare Pages _redirects + Bulk Redirect pairs from old → new URLs.', category: 'generate', icon: CornerUpRight, keywords: 'cloudflare redirect rules generator bulk redirects pages _redirects 301' },
