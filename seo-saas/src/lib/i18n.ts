...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hero.desc': 'Paste a URL and get a full SEO report — 100 on-page checks with copy-paste code fixes, not just warnings. Under 10 seconds, no signup.',
    ...
    'demo.reportTitle': 'Your free SEO report, in seconds', 'demo.reportDesc': 'Every scan returns a shareable SEO report: an overall score, prioritized issues, a security grade, and copy-paste code to fix each one.',
    ...
    'login.name.ph': 'Your name', 'login.pw.ph': 'Your password', 'login.pw.ph.reg': 'At least 6 characters',
    'login.or': 'or', 'login.google': 'Continue with Google', 'login.github': 'Continue with GitHub',
    'login.err.register': 'Registration failed', 'login.err.afterRegister': 'Account created but login failed. Try logging in.', 'login.err.invalid': 'Invalid email or password',
  ...
  tr: {
    ...
    'hero.desc': "Bir URL yapıştır, tam bir SEO raporu al — 100 sayfa-içi kontrol, kopyala-yapıştır kod düzeltmeleriyle, sadece uyarı değil. 10 saniyeden kısa, kayıt yok.",
    ...
    'demo.reportTitle': 'Saniyeler i\u00e7inde \u00fccretsiz SEO raporunuz', 'demo.reportDesc': 'Her tarama payla\u015f\u0131labilir bir SEO raporu d\u00f6nd\u00fcr\u00fcr: genel puan, \u00f6nceliklendirilmi\u015f sorunlar, g\u00fcvenlik notu ve her birini d\u00fczeltmek i\u00e7in kopyala-yap\u0131\u015ft\u0131r kod.',
    ...
    'pf.5day': 'Günde 5 analiz', 'pf.score': 'SEO skoru ve sorunlar', 'pf.meta': 'Meta etiket analizi',
    'pf.og': 'Open Graph ve şema', 'pf.json': 'JSON dışa aktarma', 'pf.cwv': 'Core Web Vitals',
    'pf.pdf': 'PDF raporlar', 'pf.monitor': 'Zamanlanmış izleme',
    'pf.unlimited': 'Sınırsız analiz', 'pf.everything': 'Ücretsiz plandaki her şey',
    'pf.cwvfull': 'Core Web Vitals (FCP, LCP, CLS)', 'pf.secaudit': 'Güvenlik ve erişilebilirlik denetimi',
    'pf.pdfexport': 'PDF rapor dışa aktarma', 'pf.share': 'Paylaşılabilir herkese açık raporlar',
    'pf.weekly': 'Haftalık izleme', 'pf.priority': 'Öncelikli destek',
    'pf.everythingpro': 'Pro plandaki her şey', 'pf.norecurring': 'Tekrarlayan ücret yok',
    'pf.allfuture': 'Tüm gelecek özellikler', 'pf.daily': 'Günlük izleme',
    'pf.api': 'API erişimi (yakında)', 'pf.early': 'Erken erişim',
    'early.badge': 'Erken Kullanıcı Fiyatı — Bu fiyatlar artacak. Şimdi sabitleyin.',
    'login.name.ph': 'Adınız', 'login.pw.ph': 'Şifreniz', 'login.pw.ph.reg': 'En az 6 karakter',
    'login.or': 'veya', 'login.google': 'Google ile devam et', 'login.github': 'GitHub ile devam et',
    'login.err.register': 'Kayıt başarısız', 'login.err.afterRegister': 'Hesap oluşturuldu ama giriş başarısız. Giriş yapmayı deneyin.', 'login.err.invalid': 'Geçersiz e-posta veya şifre',
  ...
  de: {
    ...
    'hero.desc': 'URL einfügen und einen vollständigen SEO-Report erhalten — 100 On-Page-Checks mit Copy-paste-Code-Fixes, nicht nur Warnungen. Unter 10 Sekunden, ohne Anmeldung.',
    ...
    'demo.reportTitle': 'Ihr kostenloser SEO-Report, in Sekunden', 'demo.reportDesc': 'Jeder Scan liefert einen teilbaren SEO-Report: Gesamtscore, priorisierte Probleme, Sicherheitsnote und Copy-paste-Code zur Behebung.',
    ...
    'pf.5day': '5 Analysen pro Tag', 'pf.score': 'SEO-Score & Probleme', 'pf.meta': 'Meta-Tag-Analyse',
    'pf.og': 'Open Graph & Schema', 'pf.json': 'JSON-Export', 'pf.cwv': 'Core Web Vitals',
    'pf.pdf': 'PDF-Berichte', 'pf.monitor': 'Geplantes Monitoring',
    'pf.unlimited': 'Unbegrenzte Analysen', 'pf.everything': 'Alles aus Kostenlos',
    'pf.cwvfull': 'Core Web Vitals (FCP, LCP, CLS)', 'pf.secaudit': 'Sicherheits- & Barrierefreiheits-Audit',
    'pf.pdfexport': 'PDF-Bericht-Export', 'pf.share': 'Teilbare öffentliche Berichte',
    'pf.weekly': 'Wöchentliches Monitoring', 'pf.priority': 'Prioritäts-Support',
    'pf.everythingpro': 'Alles aus Pro', 'pf.norecurring': 'Keine wiederkehrenden Gebühren',
    'pf.allfuture': 'Alle zukünftigen Features', 'pf.daily': 'Tägliches Monitoring',
    'pf.api': 'API-Zugang (bald)', 'pf.early': 'Früher Zugang',
    'early.badge': 'Early-Adopter-Preis — Diese Preise werden steigen. Sichern Sie sich jetzt Ihren Tarif.',
    'login.name.ph': 'Ihr Name', 'login.pw.ph': 'Ihr Passwort', 'login.pw.ph.reg': 'Mindestens 6 Zeichen',
    'login.or': 'oder', 'login.google': 'Mit Google fortfahren', 'login.github': 'Mit GitHub fortfahren',
    'login.err.register': 'Registrierung fehlgeschlagen', 'login.err.afterRegister': 'Konto erstellt, aber Anmeldung fehlgeschlagen. Bitte anmelden.', 'login.err.invalid': 'Ungültige E-Mail oder Passwort',
    'pricing.loading': 'Wird geladen...',
    'footer.copy': '© 2026 SEO Snapshot',
  },
  ...
  es: {
    ...
    'hero.desc': 'Pega una URL y obtén un informe SEO completo — 100 comprobaciones on-page con correcciones de código listas para copiar, no solo avisos. En menos de 10 segundos, sin registro.',
    ...
    'demo.reportTitle': 'Tu informe SEO gratis, en segundos', 'demo.reportDesc': 'Cada an\u00e1lisis devuelve un informe SEO para compartir: puntuaci\u00f3n general, problemas priorizados, nota de seguridad y c\u00f3digo listo para copiar y corregir cada uno.',
    ...
    'pf.5day': '5 análisis por día', 'pf.score': 'Puntuación SEO y problemas', 'pf.meta': 'Análisis de meta etiquetas',
    'pf.og': 'Open Graph y schema', 'pf.json': 'Exportar JSON', 'pf.cwv': 'Core Web Vitals',
    'pf.pdf': 'Informes PDF', 'pf.monitor': 'Monitoreo programado',
    'pf.unlimited': 'Análisis ilimitados', 'pf.everything': 'Todo lo del plan Gratis',
    'pf.cwvfull': 'Core Web Vitals (FCP, LCP, CLS)', 'pf.secaudit': 'Auditoría de seguridad y accesibilidad',
    'pf.pdfexport': 'Exportar informe PDF', 'pf.share': 'Informes públicos compartibles',
    'pf.weekly': 'Monitoreo semanal', 'pf.priority': 'Soporte prioritario',
    'pf.everythingpro': 'Todo lo del plan Pro', 'pf.norecurring': 'Sin cuotas recurrentes',
    'pf.allfuture': 'Todas las funciones futuras', 'pf.daily': 'Monitoreo diario',
    'pf.api': 'Acceso API (próximamente)', 'pf.early': 'Acceso anticipado',
    'early.badge': 'Precio para primeros usuarios — Estos precios subirán. Asegura tu tarifa ahora.',
    'login.name.ph': 'Tu nombre', 'login.pw.ph': 'Tu contraseña', 'login.pw.ph.reg': 'Al menos 6 caracteres',
    'login.or': 'o', 'login.google': 'Continuar con Google', 'login.github': 'Continuar con GitHub',
    'login.err.register': 'Registro fallido', 'login.err.afterRegister': 'Cuenta creada pero inicio de sesión fallido. Intenta iniciar sesión.', 'login.err.invalid': 'Correo o contraseña inválidos',
  ...
  fr: {
    ...
    'hero.desc': "Collez une URL et obtenez un rapport SEO complet — 100 vérifications on-page avec des correctifs de code prêts à copier, pas juste des alertes. En moins de 10 secondes, sans inscription.",
    ...
    'demo.reportTitle': 'Votre rapport SEO gratuit, en secondes', 'demo.reportDesc': 'Chaque analyse renvoie un rapport SEO partageable : score global, probl\u00e8mes prioris\u00e9s, note de s\u00e9curit\u00e9 et code pr\u00eat \u00e0 copier pour tout corriger.',
    ...
    'pf.5day': '5 analyses par jour', 'pf.score': 'Score SEO et problèmes', 'pf.meta': 'Analyse des balises meta',
    'pf.og': 'Open Graph et schema', 'pf.json': 'Export JSON', 'pf.cwv': 'Core Web Vitals',
    'pf.pdf': 'Rapports PDF', 'pf.monitor': 'Surveillance planifiée',
    'pf.unlimited': 'Analyses illimitées', 'pf.everything': 'Tout du plan Gratuit',
    'pf.cwvfull': 'Core Web Vitals (FCP, LCP, CLS)', 'pf.secaudit': 'Audit de sécurité et accessibilité',
    'pf.pdfexport': 'Export de rapport PDF', 'pf.share': 'Rapports publics partageables',
    'pf.weekly': 'Surveillance hebdomadaire', 'pf.priority': 'Support prioritaire',
    'pf.everythingpro': 'Tout du plan Pro', 'pf.norecurring': 'Pas de frais récurrents',
    'pf.allfuture': 'Toutes les fonctionnalités futures', 'pf.daily': 'Surveillance quotidienne',
    'pf.api': 'Accès API (bientôt)', 'pf.early': 'Accès anticipé',
    'early.badge': 'Tarif précurseur — Ces prix vont augmenter. Bloquez votre tarif maintenant.',
    'login.name.ph': 'Votre nom', 'login.pw.ph': 'Votre mot de passe', 'login.pw.ph.reg': 'Au moins 6 caractères',
    'login.or': 'ou', 'login.google': 'Continuer avec Google', 'login.github': 'Continuer avec GitHub',
    'login.err.register': 'Échec de l\'inscription', 'login.err.afterRegister': 'Compte créé mais connexion échouée. Essayez de vous connecter.', 'login.err.invalid': 'E-mail ou mot de passe invalide',
