...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // Diff examples
    'diff.ex1': '"Add a meta description"',
    'diff.ex2': '"Improve security headers"',
    'diff.ex3': '"Add structured data"',
    'diff.us.copy': 'Copy-paste',
    'diff.us.tag': 'tag',
    'diff.us.nginx': 'nginx / next.config.js code',
    'diff.us.jsonld': 'Complete JSON-LD schema',

    // Demo preview
    'demo.issues': 'issues found', 'demo.response': 'response', 'demo.try': 'Try it yourself — enter any URL above',

    // Pricing extras
    'pricing.popular': 'POPULAR', 'pricing.faq': 'FAQ',
    'faq.cancel.q': 'Can I cancel anytime?', 'faq.cancel.a': 'Yes. Cancel from your Paddle billing portal. You keep access until the end of your billing period.',
  ...
  tr: {
    ...
    'feat.seo': 'SEO Skoru', 'feat.seo.d': 'Ba\u015fl\u0131k, meta, OG etiketleri, \u015fema \u2014 0-100 puan.',
    'feat.cwv': 'Core Web Vitals', 'feat.cwv.d': 'Google PageSpeed ile FCP, LCP, CLS, TBT.',
    'feat.sec': 'G\u00fcvenlik', 'feat.sec.d': 'HSTS, CSP, X-Frame-Options \u2014 ger\u00e7ek HTTP ba\u015fl\u0131klar\u0131.',
    'feat.mob': 'Mobil', 'feat.mob.d': 'Viewport, zoom, dokunma hedefleri.',
    'feat.a11y': 'Eri\u015filebilirlik', 'feat.a11y.d': 'Form etiketleri, ba\u015fl\u0131k hiyerar\u015fisi, alt metin.',
    'feat.pdf': 'PDF Raporlar', 'feat.pdf.d': 'Markal\u0131 PDF raporlar\u0131 d\u0131\u015fa aktar\u0131n.',
    'feat.social': 'Sosyal & OG', 'feat.social.d': 'Open Graph, Twitter Card, JSON-LD do\u011frulamas\u0131.',
    'feat.tech': 'Teknik', 'feat.tech.d': 'Robots.txt, sitemap.xml, canonical.',
    'feat.mon': '\u0130zleme', 'feat.mon.d': 'Haftal\u0131k SEO kontrolleri planlay\u0131n.',
    'diff.ex1': '"Meta a\u00e7\u0131klama ekleyin"',
    'diff.ex2': '"G\u00fcvenlik ba\u015fl\u0131klar\u0131n\u0131 iyile\u015ftirin"',
    'diff.ex3': '"Yap\u0131land\u0131r\u0131lm\u0131\u015f veri ekleyin"',
    'diff.us.copy': 'Kopyala-yap\u0131\u015ft\u0131r',
    'diff.us.tag': 'etiketi',
    'diff.us.nginx': 'nginx / next.config.js kodu',
    'diff.us.jsonld': 'Eksiksiz JSON-LD \u015femas\u0131',
    'demo.issues': 'sorun bulundu', 'demo.response': 'yan\u0131t', 'demo.try': 'Kendiniz deneyin \u2014 yukar\u0131ya URL girin',
    'pricing.popular': 'POP\u00dcLER', 'pricing.faq': 'SSS',
    'faq.cancel.q': '\u0130stedi\u011fim zaman iptal edebilir miyim?', 'faq.cancel.a': 'Evet. Paddle faturaland\u0131rma portalinizden iptal edin.',
  ...
  de: {
    ...
    'feat.seo': 'SEO-Score', 'feat.seo.d': 'Titel, Meta, \u00dcberschriften, OG-Tags \u2014 0-100 Punkte.',
    'feat.cwv': 'Core Web Vitals', 'feat.cwv.d': 'FCP, LCP, CLS, TBT \u00fcber PageSpeed API.',
    'feat.sec': 'Sicherheit', 'feat.sec.d': 'HSTS, CSP, X-Frame-Options \u2014 echte Header.',
    'feat.mob': 'Mobil', 'feat.mob.d': 'Viewport, Zoom, Touch-Targets.',
    'feat.a11y': 'Barrierefreiheit', 'feat.a11y.d': 'Labels, \u00dcberschriften, Alt-Text.',
    'feat.pdf': 'PDF-Berichte', 'feat.pdf.d': 'Branded PDF-Berichte exportieren.',
    'feat.social': 'Social & OG', 'feat.social.d': 'Open Graph, Twitter Card Validierung.',
    'feat.tech': 'Technisch', 'feat.tech.d': 'Robots.txt, Sitemap, Canonical.',
    'feat.mon': 'Monitoring', 'feat.mon.d': 'W\u00f6chentliche SEO-Checks planen.',
    'diff.ex1': '"Meta-Beschreibung hinzuf\u00fcgen"',
    'diff.ex2': '"Sicherheits-Header verbessern"',
    'diff.ex3': '"Strukturierte Daten hinzuf\u00fcgen"',
    'diff.us.copy': 'Copy-Paste',
    'diff.us.tag': 'Tag',
    'diff.us.nginx': 'nginx / next.config.js Code',
    'diff.us.jsonld': 'Vollst\u00e4ndiges JSON-LD Schema',
    'demo.issues': 'Probleme gefunden', 'demo.response': 'Antwort', 'demo.try': 'Probieren Sie es \u2014 URL oben eingeben',
    'pricing.popular': 'BELIEBT', 'pricing.faq': 'FAQ',
    'faq.cancel.q': 'Kann ich jederzeit k\u00fcndigen?', 'faq.cancel.a': 'Ja. K\u00fcndigen Sie \u00fcber das Paddle-Portal.',
  ...
  es: {
    ...
    'feat.seo': 'Puntuaci\u00f3n SEO', 'feat.seo.d': 'T\u00edtulo, meta, OG, schema \u2014 0-100 puntos.',
    'feat.cwv': 'Core Web Vitals', 'feat.cwv.d': 'FCP, LCP, CLS, TBT v\u00eda PageSpeed API.',
    'feat.sec': 'Seguridad', 'feat.sec.d': 'HSTS, CSP, X-Frame-Options \u2014 cabeceras reales.',
    'feat.mob': 'M\u00f3vil', 'feat.mob.d': 'Viewport, zoom, targets t\u00e1ctiles.',
    'feat.a11y': 'Accesibilidad', 'feat.a11y.d': 'Labels, jerarqu\u00eda, alt text.',
    'feat.pdf': 'Informes PDF', 'feat.pdf.d': 'Exporta informes PDF con marca.',
    'feat.social': 'Social & OG', 'feat.social.d': 'Open Graph, Twitter Card, JSON-LD.',
    'feat.tech': 'T\u00e9cnico', 'feat.tech.d': 'Robots.txt, sitemap.xml, canonical.',
    'feat.mon': 'Monitoreo', 'feat.mon.d': 'Verificaciones SEO semanales.',
    'diff.ex1': '"A\u00f1ade una meta descripci\u00f3n"',
    'diff.ex2': '"Mejora las cabeceras de seguridad"',
    'diff.ex3': '"A\u00f1ade datos estructurados"',
    'diff.us.copy': 'Copia y pega',
    'diff.us.tag': 'etiqueta',
    'diff.us.nginx': 'c\u00f3digo nginx / next.config.js',
    'diff.us.jsonld': 'Esquema JSON-LD completo',
    'demo.issues': 'problemas', 'demo.response': 'respuesta', 'demo.try': 'Pru\u00e9balo \u2014 ingresa una URL arriba',
    'pricing.popular': 'POPULAR', 'pricing.faq': 'Preguntas',
    'faq.cancel.q': 'Puedo cancelar?', 'faq.cancel.a': 'S\u00ed. Cancela desde el portal de Paddle.',
  ...
  fr: {
    ...
    'feat.seo': 'Score SEO', 'feat.seo.d': 'Titre, meta, OG, schema \u2014 score 0-100.',
    'feat.cwv': 'Core Web Vitals', 'feat.cwv.d': 'FCP, LCP, CLS, TBT via PageSpeed API.',
    'feat.sec': 'S\u00e9curit\u00e9', 'feat.sec.d': 'HSTS, CSP, X-Frame-Options \u2014 vrais en-t\u00eates.',
    'feat.mob': 'Mobile', 'feat.mob.d': 'Viewport, zoom, cibles tactiles.',
    'feat.a11y': 'Accessibilit\u00e9', 'feat.a11y.d': 'Labels, hi\u00e9rarchie, alt text.',
    'feat.pdf': 'Rapports PDF', 'feat.pdf.d': 'Exportez des rapports PDF.',
    'feat.social': 'Social & OG', 'feat.social.d': 'Open Graph, Twitter Card, JSON-LD.',
    'feat.tech': 'Technique', 'feat.tech.d': 'Robots.txt, sitemap.xml, canonical.',
    'feat.mon': 'Surveillance', 'feat.mon.d': 'V\u00e9rifications SEO hebdomadaires.',
    'diff.ex1': '"Ajoutez une meta description"',
    'diff.ex2': '"Am\u00e9liorez les en-t\u00eates de s\u00e9curit\u00e9"',
    'diff.ex3': '"Ajoutez des donn\u00e9es structur\u00e9es"',
    'diff.us.copy': 'Copier-coller',
    'diff.us.tag': 'balise',
    'diff.us.nginx': 'code nginx / next.config.js',
    'diff.us.jsonld': 'Sch\u00e9ma JSON-LD complet',
    'demo.issues': 'probl\u00e8mes', 'demo.response': 'r\u00e9ponse', 'demo.try': 'Essayez \u2014 entrez une URL ci-dessus',
    'pricing.popular': 'POPULAIRE', 'pricing.faq': 'FAQ',
    'faq.cancel.q': 'Puis-je annuler ?', 'faq.cancel.a': 'Oui. Annulez depuis le portail Paddle.',
