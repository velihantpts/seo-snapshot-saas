  ...
  return (
    <div className="min-h-screen bg-surface relative">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-white/40 text-sm mb-8 max-w-xl">Proud of your score? Embed a live badge in your site footer, GitHub README, or docs. Copy the snippet below.</p>
        <Client />
      </div>
    </div>
  );
