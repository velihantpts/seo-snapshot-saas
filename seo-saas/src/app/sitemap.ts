...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/data`, lastModified: SITE_UPDATED, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${base}/tools/netlify-redirects-generator`, lastModified: SITE_UPDATED, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/tools/vercel-redirects-generator`, lastModified: SITE_UPDATED, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/tools/cloudflare-redirect-rules-generator`, lastModified: SITE_UPDATED, changeFrequency: 'monthly', priority: 0.7 },
