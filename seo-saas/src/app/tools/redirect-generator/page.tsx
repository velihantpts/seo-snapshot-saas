  ...
  return (
    <div className="min-h-screen bg-surface relative">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-white/40 text-sm mb-8 max-w-2xl">Turn a list of old → new URLs into ready-to-paste redirect rules for Apache <code className="text-accent-300">.htaccess</code> or Nginx. Perfect for site migrations and URL changes.</p>
        <Client />
