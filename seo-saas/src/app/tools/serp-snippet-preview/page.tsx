  ...
  return (
    <div className="min-h-screen bg-surface relative">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <ToolHeader />
        <p className="text-white/60 text-sm mb-8 max-w-2xl">Write a title tag and meta description and see the pixel-accurate Google preview — including exactly where each gets truncated on desktop and mobile.</p>
        <Client />
