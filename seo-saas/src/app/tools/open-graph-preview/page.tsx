  ...
  return (
    <div className="min-h-screen bg-surface relative">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-white/40 text-sm mb-8 max-w-2xl">See exactly how your link will look when shared on Facebook, X/Twitter, LinkedIn, and Discord — then copy the <code className="text-accent-300">og:</code> and Twitter Card tags to fix it.</p>
        <Client />
